...
## Étape 1 : Choisir votre moteur de stockage
...
### Installation
Téléchargez et lancez le fichier `Prospectius_Setup.exe`. Suivez les instructions pour installer l'application sur votre ordinateur. Un raccourci sera automatiquement créé sur votre bureau.
...
**Note :** Prospectius préparera automatiquement votre espace de travail lors de la première connexion. Aucune importation manuelle de base de données n'est nécessaire.
